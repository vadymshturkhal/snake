...
from trainers.n_step_sweeping_trainer import NStepSweepingTrainer
...
class DynaQSweeping:
    def __init__(self, is_load_weights=False, weights_filename=None, epochs=100, is_load_n_games=True, steps=TRAINER_STEPS):
        self.epsilon = 1
        self.epochs = epochs
        ...
        self.trainer = NStepSweepingTrainer(self.model, lr=LR, gamma=self.gamma)
        self._steps = steps
